...
BLOG_AUTHOR = "Samuel Svenningsen"  # (translatable)
BLOG_TITLE = "Sven's Portfolio"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://altock.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://altock.github.io/"
BLOG_EMAIL = "svenningsensamuel@gmail.com"
BLOG_DESCRIPTION = "This is a portfolio site for Samuel \"Sven\" Svenningsen"  # (translatable)
...
NAVIGATION_LINKS = {
        DEFAULT_LANG: (
            ...
            ('https://github.com/altock', 'My Github', 'icon-github'),
        )
    }
...
NEW_POST_DATE_PATH_FORMAT = '%m/%d/%Y'
